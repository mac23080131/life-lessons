...
export const authApi = {
  ...
  updateProfile: async (data: { name?: string; avatar?: string; locale?: string; tz?: string; privacyDefault?: string }) => {
...
export const lessonsApi = {
  getAll: async (params?: {
    ...
    const response = await apiClient.get('/lessons', { params: filteredParams });
    return response.data;
  },
...
export const challengesApi = {
  getCommunity: async () => {
    const response = await apiClient.get('/challenges/community');
    return response.data;
  },
  ...
  getGroup: async (groupId: string) => {
    const response = await apiClient.get(`/challenges/group/${groupId}`);
    return response.data;
  },
