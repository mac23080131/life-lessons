      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute bottom-16 sm:bottom-20 right-0 space-y-2 sm:space-y-3"
          >
            ...
            {onVoiceCapture && (
              <motion.button
                ...
                className={cn(
                  'flex items-center gap-2 sm:gap-3 px-3 py-2 sm:px-4 sm:py-3 rounded-full',
              ...
              >
                ...
                <span className="pr-1 sm:pr-2">Voice Note</span>
              </motion.button>
            )}
            ...
            >
              ...
              <span className="pr-1 sm:pr-2">New Lesson</span>
            </motion.button>
          </motion.div>
        )}
      </AnimatePresence>
